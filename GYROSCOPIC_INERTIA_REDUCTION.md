[twitter]https://x.com/Rainmaker1973/status/2000113350374818290[/twitter]
...
[b]He CANNOT lift it with ONE hand WITHOUT rotation.
He CAN lift it with ONE hand WITH rotation.
[/b]
or more precisely,

[b]He CAN lift it with TWO hands WITH STRUGGLING, WITHOUT rotation.
...
[b]A spinning rocket/wheel can be lifted with LESS PROPELLANT.[/b]

Again,

[b]He can NOT lift it with one hand without rotation.
He CAN lift it with one hand with rotation.[/b]

--> A SPINNING ROCKET/WHEEL CAN BE LIFTED WITH LESS PROPELLANT!

Either the gyroscopic effect is translating rotation energy into lateral movement work, or, [b]it is reducing the lateral/upward movement inertia.[/b]

In the following video Veritasium shows that the weight does not change whether or not a gyroscope rotates.

[youtube]https://www.youtube.com/watch?v=tLMpdBjA2SU[/youtube]
...
[u]Professor Eric Laithwaite gave it "higher precession" AND jerked it upward and continued pushing.[/u]

[u]Veritasium only gave the gyroscope "higher precession" on the scale.[/u] There was no additional force beyond the g-scale, there was no extra lift. There was no jerking upwards, no overall upwards movement.
...
[b]What Professor Eric Laithwaite did and what Veritasium showed on the scale are different.[/b]

------

[b]LOOK HOW HARD IT IS WITH ONE HAND WITHOUT SPINNING!
THAT IS NOT JUST AN ILLUSION OR FEELING.
IT IS ACTUALLY DIFFERENT IN BEHAVIOR![/b]

[youtube]https://youtu.be/GeyDf4ooPdo?t=116[/youtube]
...
[twitter]https://x.com/jaekwon/status/2000571260494127526[/twitter]

If you use the upward momentum of the spinning weight and then let the rod rotate with how the spinning weight wants to rotate without exerting any other force on the rod, you have effectively translated rotational inertia into upwards movement inertia of the whole system without any exhaust.

If you have a sophisticated arbitrary rotational system to hold it all together, you can get lift from a completely enclosed system; e.g. a battery.

So this must be how the tic tac works.

You just need a wheel, a rod, contained in an inner sphere, which rotates arbitrarily within an outer sphere, and magnetic omnidirectional forces applied to the inner sphere.

You need the rod to be anchored to the inner sphere at one end at a time, or both ends at once depending on the situation.
...
And yet there absolutely is something here that is not explainable by newtonian physics.

That is what I am pointing at.

Something new.

[b]I understand the reflex to say that there is nothing new under the sun, and all can be explained by newtonian physics.
...
Or, [b]perhaps a dual-rotating body such as the wheel creates its own frame of inertial and reduces the effect of gravity upon it. This would be much more surprising, but is related to the US UFO patent that expired; though in that patent there is only single-rotation, so maybe that's enough.[/b]
